...
import com.metasoft.em.utils.DateUtils;
...
public class EmployeeModel {
	...
	public String getDobStr() {
		if(dob!=null){
			dobStr = DateUtils.convertToString(dob, "yyyy-MM-dd");
		}
		return dobStr;
	}
	...
	public String getEntryDateStr() {
		if(entryDate!=null){
			entryDateStr = DateUtils.convertToString(entryDate, "yyyy-MM-dd");
		}
		return entryDateStr;
	}
	...
	public String getLeaveDateStr() {
		if(leaveDate!=null){
			leaveDateStr = DateUtils.convertToString(leaveDate, "yyyy-MM-dd");
		}
		return leaveDateStr;
	}
